...
- [ مدت استفاده از محصولات](#مدت-استفاده-از-محصولات)
...
> <i class='fas fa-info' style='font-size:20px;color:gray;margin-left:15px'></i>
> امکان پرینت و دریافت فایل PDF از صورتحساب ها به سامانه و در بخش صورتحساب اضافه شده است.
...
درگاه های پرداختی که در سامانه مهر استفاده می شوند به ترتیب زیر می باشند:
...
برای افزودن/حذف هر یک از درگاه ها با ما تماس بگیرید.

[بالا↑](#)

##### مدت استفاده از محصولات

برای استفاده از محصولات تعریف شده در سامانه مدت زمان تعریف شده است. این زمان با توجه به تاریخ صورتحساب محاسبه میشود و قابل تغییر نیز میباشد.
![](duration3.png)

برای تغییر مدت زمان استفاده از محصولات برای هر کابر از منو عملیات اقدام کرده و در صفحه باز شده این عدد را تغییر دهید.
![](duration2.png)
